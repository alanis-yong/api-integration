  ...
  return (
    <div className="shop">
        ...
        <div className="shop__header-inner">
          ...
          <nav className="shop__nav">
            <Link
              ...
              className={[
                "shop__nav-link",
                location.pathname === "/" && "shop__nav-link--active",
              ]
                .filter(Boolean)
                .join(" ")}
            >
            ...
            <Link
              ...
              className={[
                "shop__cart-btn",
                location.pathname === "/cart" && "shop__cart-btn--active",
              ]
                .filter(Boolean)
                .join(" ")}
            >
              ...
              Cart
              {totalItems > 0 && (
                <span className="shop__cart-badge">{totalItems}</span>
              )}
            </Link>
            {tokenEmail ? (
              <button
                className="shop__login-btn shop__login-btn--user"
                disabled
              >
                {tokenEmail}
              </button>
      ...
      <footer className="shop__footer">
        <p>© 2026 Not William's Shop. No rights reserved.</p>
      </footer>
